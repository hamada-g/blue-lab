...
| Linux Endpoint 1 | Planned Endpoint VM | Lab | Ubuntu Desktop | 10.10.10.30 | Planned monitored Linux endpoint for agent enrollment and log collection |

## Environment Notes
- The lab is being built within a personal/home network.
- Phase 1 uses virtual machines rather than separate physical hardware.
